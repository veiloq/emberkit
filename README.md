...
Alternatively, if you have Go installed, you can install the library (primarily for use as a dependency in your tests) using:
...
func TestWithHooks(t *testing.T) {
	...
	k, err := kit.NewEmberKit(ctx, t, config.DefaultConfig, opts...)
